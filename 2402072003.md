...
## x86 Hardware Logic
When thinking of a stack, it is typical to imagine a concept similar to a stack of dishes. However, in the x86 architecture, the stack is placed head down. The stack begins at a high address and grows 'downward' — meaning the top of the stack refers to the lowest address within the stack frame.[^1][^2] It is as follows:
```
high addr
     +----+
